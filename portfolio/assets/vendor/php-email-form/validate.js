...
(function () {
  ...
  function php_email_form_submit(thisForm, action, formData) {
    fetch(action, {
      ...
      .catch((error) => {
        ...
        displayError(thisForm, error.message); // Use error.message to avoid 'Error: ' prefix
      });
  }
  ...
  function showSuccessMessage(thisForm) {
    let successElement = thisForm.querySelector('.sent-message');
    successElement.textContent = 'Your message has been sent. Thank you!';
